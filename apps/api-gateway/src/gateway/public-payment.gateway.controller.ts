...
export class PublicPaymentGatewayController {
  ...
  @ApiOperation({
    summary:
      'Handle incoming asynchronous payment provider webhook callbacks (Stripe, SSLCommerz, etc.)',
  })
  @ApiResponse({
    status: 200,
    description: 'Webhook event processed and verified',
  })
  @ApiParam({
    name: 'provider',
    example: 'stripe',
    description: 'Provider identifier (stripe, sslcommerz, bkash)',
  })
  @ApiBody({
